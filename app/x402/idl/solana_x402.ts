...
export type SolanaX402 = {
      ...
      "accounts": [
        {
          ...
          "pda": {
            "seeds": [
              {
                "kind": "const",
                "value": [112, 97, 121, 109, 101, 110, 116, 95, 114, 101, 113, 117, 101, 115, 116]
              },
    ...
    },
    {
      ...
      "accounts": [
        { "name": "authority", "writable": true, "signer": true },
        {
          ...
          "pda": {
            "seeds": [
              { "kind": "const", "value": [99, 111, 110, 102, 105, 103, 50] }
            ]
          }
        },
        { "name": "systemProgram", "address": "11111111111111111111111111111111" }
  ...
  "accounts": [
    { "name": "paymentConfig", "discriminator": [252, 166, 185, 239, 186, 79, 212, 152] },
  ...
  "errors": [
    ...
    { "code": 6007, "name": "unauthorizedClose", "msg": "Only the config authority can close the config account" }
  ],
  "types": [
    {
      "name": "paymentConfig",
